...
import 'package:shipper_app/functions/ongoingTrackUtils/getTraccarStoppagesByDeviceId.dart';
...
import 'package:shipper_app/screens/myLoadPages/trackOngoing/trackScreenDetailsOngoing.dart';
...
import 'package:shipper_app/functions/ongoingTrackUtils/getDataHistoryByDeviceId.dart';
import 'package:flutter_dotenv/flutter_dotenv.dart';


class TrackScreenOngoing extends StatefulWidget {
  ...
  @override
  _TrackScreenOngoingState createState() => _TrackScreenOngoingState();
}

class _TrackScreenOngoingState extends State<TrackScreenOngoing>
  ...
  void initState() {
    ...
    print("device ID ${widget.gpsData.deviceId}");
  ...
  void onActivityExecuted2() async {
    ...
    var gpsData = await getPositionByDeviceId(widget.deviceId.toString());
    setState(() {
      newGPSData = gpsData;
    });
    getTruckHistoryForSpeed();
          ...
          child: Stack(
            children: <Widget>[
              ...
              AnimatedPositioned(
                ...
                child: TrackScreenDetailsOngoing(
                  gpsData: newGPSData,
